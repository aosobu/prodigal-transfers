...
public class ComplaintCustomerServiceImpl implements ComplaintCustomerService{
    ...
    @Autowired
    public void setComplaintCustomerRepository(ComplaintCustomerRepository complaintCustomerRepository) {
        this.complaintCustomerRepository = complaintCustomerRepository;
    }
}
